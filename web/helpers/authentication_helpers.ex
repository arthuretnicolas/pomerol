defmodule Pomerol.AuthenticationHelpers do
  ...
  def handle_unauthorized(conn = %{assigns: %{authorized: false}}) do
    conn
    |> put_status(403)
    |> render(Pomerol.SessionView, "403.json", message: "You are not authorized to perform this action.")
    |> halt
  end
  ...
  def handle_not_found(conn) do
    ...
    |> render(Pomerol.ErrorView, "404.json", message: "Not found")
    |> halt
  end
